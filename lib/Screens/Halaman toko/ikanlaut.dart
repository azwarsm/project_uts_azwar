...
class IkanLaut extends StatefulWidget {
  ...
  @override
  State<IkanLaut> createState() => _IkanLaut();
}

class _IkanLaut extends State<IkanLaut> {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
        Uri.parse('http://localhost:1337/api/ikanlauts'),
      );
  ...
  Future<void> addData() async {
    ...
    final response =
        await http.post(Uri.parse('http://localhost:1337/api/ikanlauts'),
            headers: headers,
            body: jsonEncode({
              'data': {
  ...
  Future<void> deleteData(String id) async {
    final response =
        await http.delete(Uri.parse('http://localhost:1337/api/ikanlauts/$id'));
  ...
  Future<void> updateData(String id) async {
    final response = await http.put(
      Uri.parse('http://localhost:1337/api/ikanlauts/$id'),
